  ...
  <div class="app-container">
    <el-card v-if="!showDetailList" class="departmentCard">
      ...
      >
        ...
        <el-table-column prop="BrudegPipeModel" label="过桥管箱型号/长度" align="center" />
        <el-table-column prop="TunnelLength" label="是否有隧道长度/位置" align="center" />
  ...
  data() {
    return {
      ...
      tableData: [{
        ...
        PipeModel: '硅芯管∅40/33',
        Count: '12',
        BrudegPipeModel: '玻璃钢 310*190*5/800M',
        TunnelLength: '牛郎隧道560米南幅北幅/东幅西幅'
      }, {
        HoleIndex: '002',
        StartNum: 'K533+481',
        EndNum: 'K003+004',
